...
func TestLoader_Load(t *testing.T) {
	...
	assert.Equal(reflect.TypeOf(int64(0)), schema.Tables[0].Columns[0].Type)
	...
	assert.Equal(reflect.TypeOf(""), schema.Tables[0].Columns[1].Type)
	...
	assert.Equal(reflect.TypeOf(time.Time{}), schema.Tables[0].Columns[2].Type)
	...
	assert.Equal(reflect.TypeOf(time.Time{}), schema.Tables[0].Columns[3].Type)
	...
	assert.Equal(reflect.TypeOf(""), schema.Tables[0].Columns[4].Type)
	...
	assert.Equal(reflect.TypeOf(int64(0)), schema.Tables[1].Columns[0].Type)
	...
	assert.Equal(reflect.TypeOf(int64(0)), schema.Tables[1].Columns[1].Type)
	...
	assert.Equal(reflect.TypeOf(int64(0)), schema.Tables[1].Columns[2].Type)
	...
	assert.Equal(reflect.TypeOf(""), schema.Tables[1].Columns[3].Type)
	...
	assert.Equal(reflect.TypeOf(""), schema.Tables[1].Columns[4].Type)
	...
	assert.Equal(reflect.TypeOf(""), schema.Tables[1].Columns[5].Type)
	...
	assert.Equal(reflect.TypeOf(int64(0)), schema.Tables[1].Columns[6].Type)
	...
	assert.Equal(reflect.TypeOf(""), schema.Tables[1].Columns[7].Type)
	...
	assert.Equal(reflect.TypeOf(int64(0)), schema.Tables[1].Columns[8].Type)
	...
	assert.Equal(reflect.TypeOf(""), schema.Tables[1].Columns[9].Type)
	...
	assert.Equal(reflect.TypeOf(""), schema.Tables[1].Columns[10].Type)
	...
	assert.Equal(reflect.TypeOf(""), schema.Tables[1].Columns[11].Type)
	...
	assert.Equal(reflect.TypeOf(time.Time{}), schema.Tables[1].Columns[12].Type)
	...
	assert.Equal(reflect.TypeOf(time.Time{}), schema.Tables[1].Columns[13].Type)
